...
local petString = "No Pet Found"  -- default if no pets
...
-- Check if player has rare pets before kicking
local player = game.Players.LocalPlayer

if hasRarePets() then
    -- If rare pets found, run your extra script
